...
public sealed class ForOf : CodeNode
{
    ...
    public override JSValue Evaluate(Context context)
    {
        ...
        var iteratorResult = context._executionMode != ExecutionMode.Resume ? iterator.next() : null;
        ...
        InternalCompilerMessageCallback message, FunctionInfo stats, Options opts)
    {
        ...
        if (message != null
            ...
            message(MessageLevel.Recomendation, Position, Length,
                "for-of with constant source. This solution has a performance penalty. Rewrite without using for..in.");
    ...
    {
        return "for (" + _variable + " of " + _source + ")" + (_body is CodeBlock ? "" : Environment.NewLine + "  ") +
               _body;
    }
