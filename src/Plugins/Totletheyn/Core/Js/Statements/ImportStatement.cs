...
{
    private readonly List<KeyValuePair<string, Variable>> _map = new();
    ...
    internal static CodeNode Parse(ParseInfo state, ref int index)
    {
        ...
        result.SourceModuleName = Tools.Unescape(state.Code.Substring(start + 1, index - start - 2), false);
    ...
    public override JSValue Evaluate(Context context)
    {
        ...
        var module = context._module.Import(SourceModuleName);
        if (module == null)
            return null;
