...
public class Module
{
    ...
    /// </summary>
    /// <param name="path">
    ///     Path to file with script. Used for resolving paths to other modules for importing via import
    ///     directive. Can be null or empty
    /// </param>
    /// <param name="code">JavaScript code.</param>
    ...
    /// <param name="messageCallback">Callback used to output compiler messages or null</param>
    /// <param name="options">Compiler options</param>
    public Module(string virtualPath, string code, CompilerMessageCallback messageCallback = null,
        Options options = Options.None, GlobalContext globalContext = null)
    ...
    public List<IModuleResolver> ModuleResolversChain { get; } = new();
