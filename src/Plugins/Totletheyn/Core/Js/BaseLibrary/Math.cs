...
public static class Math
{
    ...
    /// </summary>
    [Hidden] private static int _randomSeed = Environment.TickCount;
    ...
    /// </remarks>
    [Hidden] internal static readonly ThreadLocal<Random> randomInstance =
        new(() => new Random(Interlocked.Increment(ref _randomSeed)));

    [DoNotDelete] [DoNotEnumerate] [NotConfigurable]
    public static readonly Number E = new(System.Math.E);

    [DoNotDelete] [DoNotEnumerate] [NotConfigurable]
    public static readonly Number PI = new(System.Math.PI);

    [DoNotDelete] [DoNotEnumerate] [NotConfigurable]
    public static readonly Number LN2 = new(System.Math.Log(2));

    [DoNotDelete] [DoNotEnumerate] [NotConfigurable]
    public static readonly Number LN10 = new(System.Math.Log(10));

    [DoNotDelete] [DoNotEnumerate] [NotConfigurable]
    public static readonly Number LOG2E = new(1.0 / System.Math.Log(2));

    [DoNotDelete] [DoNotEnumerate] [NotConfigurable]
    public static readonly Number LOG10E = new(1.0 / System.Math.Log(10));

    [DoNotDelete] [DoNotEnumerate] [NotConfigurable]
    public static readonly Number SQRT1_2 = new(System.Math.Sqrt(0.5));

    [DoNotDelete] [DoNotEnumerate] [NotConfigurable]
    public static readonly Number SQRT2 = new(System.Math.Sqrt(2));
    ...
    {
        var a = Tools.JSObjectToInt32(x, 0, 0, false);
        var b = Tools.JSObjectToInt32(y, 0, 0, false);
    ...
    {
        if (!a.Defined || !b.Defined) return Number.NaN;
