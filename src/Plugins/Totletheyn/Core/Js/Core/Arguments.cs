...
public sealed class Arguments : JSObject, IEnumerable, IIterable
{
    ...
    internal bool SuppressValuesClone
    {
        get => _dValue != 0;
        set => _dValue = value ? 1 : 0;
    } // field reuse
    ...
    {
        return this.Select(x => x.Value).GetEnumerator().AsIterator();
    }
    ...
    private static JSValue getCaller(Context callerContext)
    {
        return callerContext._strict
               ...
               && callerContext._owner._functionDefinition._body._strict
            ? Function.propertiesDummySM
            : callerContext._owner;
    }
        ...
        if (memberScope < PropertyScope.Super && key._valueType != JSValueType.Symbol)
        {
            ...
            if (key._valueType == JSValueType.Integer)
                switch (key._iValue)
                {
                    case 0:
                        return _a0 ?? (forWrite
                            ? _a0 = new JSValue { _valueType = JSValueType.NotExistsInObject }
                            : notExists);
                    case 1:
                        return _a1 ?? (forWrite
                            ? _a1 = new JSValue { _valueType = JSValueType.NotExistsInObject }
                            : notExists);
                    case 2:
                        return _a2 ?? (forWrite
                            ? _a2 = new JSValue { _valueType = JSValueType.NotExistsInObject }
                            : notExists);
                    case 3:
                        return _a3 ?? (forWrite
                            ? _a3 = new JSValue { _valueType = JSValueType.NotExistsInObject }
                            : notExists);
                }
            else
                switch (key.ToString())
                    ...
                    case "length":
                    {
                        if (_lengthContainer == null)
                            _lengthContainer = new LengthContainer(this)
                            {
                                ...
                                _iValue = _iValue,
                                _attributes = JSValueAttributesInternal.DoNotEnumerate |
                                              JSValueAttributesInternal.Reassign
                            };
        ...
        EnumerationMode enumeratorMode, PropertyScope propertyScope = PropertyScope.Common)
    {
        ...
        {
            if (_a0 != null && _a0.Exists &&
                (!hideNonEnum || (_a0._attributes & JSValueAttributesInternal.DoNotEnumerate) == 0))
                yield return new KeyValuePair<string, JSValue>("0", _a0);

            if (_a1 != null && _a1.Exists &&
                (!hideNonEnum || (_a1._attributes & JSValueAttributesInternal.DoNotEnumerate) == 0))
                yield return new KeyValuePair<string, JSValue>("1", _a1);

            if (_a2 != null && _a2.Exists &&
                (!hideNonEnum || (_a2._attributes & JSValueAttributesInternal.DoNotEnumerate) == 0))
                yield return new KeyValuePair<string, JSValue>("2", _a2);

            if (_a3 != null && _a3.Exists &&
                (!hideNonEnum || (_a3._attributes & JSValueAttributesInternal.DoNotEnumerate) == 0))
                yield return new KeyValuePair<string, JSValue>("3", _a3);

            if (_callee != null && _callee.Exists &&
                (!hideNonEnum || (_callee._attributes & JSValueAttributesInternal.DoNotEnumerate) == 0))
                yield return new KeyValuePair<string, JSValue>("callee", _callee);

            if (_caller != null && _caller.Exists &&
                (!hideNonEnum || (_caller._attributes & JSValueAttributesInternal.DoNotEnumerate) == 0))
                yield return new KeyValuePair<string, JSValue>("caller", _caller);

            if (_lengthContainer != null && _lengthContainer.Exists && (!hideNonEnum ||
                                                                        (_lengthContainer._attributes &
                                                                         JSValueAttributesInternal.DoNotEnumerate) ==
                                                                        0))
    ...
    protected internal override bool DeleteProperty(JSValue name)
    {
        if (name._valueType == JSValueType.Integer)
            ...
            {
                case 0:
                    return _a0 == null || ((_a0._attributes & JSValueAttributesInternal.DoNotDelete) == 0 &&
                                           (_a0 = null) == null);
                case 1:
                    return _a1 == null || ((_a1._attributes & JSValueAttributesInternal.DoNotDelete) == 0 &&
                                           (_a1 = null) == null);
                case 2:
                    return _a2 == null || ((_a2._attributes & JSValueAttributesInternal.DoNotDelete) == 0 &&
                                           (_a2 = null) == null);
                case 3:
                    return _a3 == null || ((_a3._attributes & JSValueAttributesInternal.DoNotDelete) == 0 &&
                                           (_a3 = null) == null);
            }
