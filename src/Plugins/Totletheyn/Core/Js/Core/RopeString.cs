...
public sealed class RopeString
{
    ...
    private static void append(StringBuilder sb, object arg)
    {
        ...
        for (var i = 0; i < str.Length; i++) sb[start + i] = str[i];
    }
            ...
            else
            {
                ...
                while (stack.Count != 0)
                {
                    if (step.Peek() < 1)
                    {
                        ...
                        append(res, stack.Peek().firstPart ?? "");
                        step.Pop();
                        step.Push(1);
                    }
                    ...
                    if (step.Peek() < 2)
                    {
                        ...
                        append(res, stack.Peek().secondPart ?? "");
                        step.Pop();
                        step.Push(2);
                    }
