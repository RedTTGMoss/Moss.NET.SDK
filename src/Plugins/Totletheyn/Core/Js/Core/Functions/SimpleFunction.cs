...
internal sealed class SimpleFunction : Function
{
        ...
        bool withSpread, bool construct)
    {
        ...
        if (_functionDefinition._parameters.Length ==
            arguments.Length // из-за необходимости иметь возможность построить аргументы, если они потребуются
            && arguments.Length < 9)
                    ...
                    if (argumentsCount > 4)
                    {
                        ...
                        if (argumentsCount > 5)
                        {
                            ...
                            if (argumentsCount > 6)
                            {
                                ...
                                if (argumentsCount > 7) a7 = Tools.EvalExpressionSafe(initiator, arguments[7]);
                            }
                        }
                    }
                }
                    ...
                    if (argumentsCount > 4)
                    {
                        ...
                        if (argumentsCount > 5)
                        {
                            ...
                            if (argumentsCount > 6)
                            {
                                ...
                                if (argumentsCount > 7) setParamValue(7, a7, internalContext);
                            }
                        }
                    }
                }
    ...
    private void setParamValue(int index, JSValue value, Context context)
    {
        ...
        if (!value.Defined && _functionDefinition._parameters.Length > index &&
            _functionDefinition._parameters[index].initializer != null)
