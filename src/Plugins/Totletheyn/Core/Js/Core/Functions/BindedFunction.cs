...
internal sealed class BindedFunction : Function
{
        ...
        : base(proto.Context, proto._functionDefinition)
    {
        ...
        _target = proto;
        _thisBind = args[0];
        _bindedArguments = new JSValue[Math.Max(args.Length - 1, 0)];
        if (args.Length > 0)
        {
    ...
    protected internal override JSValue Invoke(bool construct, JSValue targetObject, Arguments arguments)
    {
        ...
        if ((construct || _thisBind == null || _thisBind.IsNull || !_thisBind.Defined) && targetObject != null &&
            targetObject.Defined)
