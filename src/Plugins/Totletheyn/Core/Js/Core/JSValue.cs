...
public enum JSValueType
{
    ...
    Undefined =
        3, // 000000000011 // значение undefined говорит о том, что этот объект, вообще-то, определён, но вот его значение нет
...
internal sealed class JSObjectDebugView
{
    ...
    public KeyValuePair<string, JSValue>[] Items => _jsObject == null
        ? EmpryArrayHelper.Empty<KeyValuePair<string, JSValue>>()
        : _jsObject.ToArray();
}
...
#endif
{
    ...
    internal static readonly JSValue undefined = new()
    {
        ...
        _attributes = JSValueAttributesInternal.DoNotDelete | JSValueAttributesInternal.DoNotEnumerate |
                      JSValueAttributesInternal.ReadOnly | JSValueAttributesInternal.NonConfigurable |
                      JSValueAttributesInternal.SystemObject
    };

    internal static readonly JSValue notExists = new()
    {
    ...
    internal static readonly JSObject @null = new()
    {
        _valueType = JSValueType.Object, _oValue = null,
        _attributes = JSValueAttributesInternal.DoNotEnumerate | JSValueAttributesInternal.SystemObject
    };

    internal static readonly JSValue nullString = new()
    {
        _valueType = JSValueType.String, _oValue = "null",
        _attributes = JSValueAttributesInternal.DoNotDelete | JSValueAttributesInternal.DoNotEnumerate |
                      JSValueAttributesInternal.SystemObject
    };
    ...
    {
        [Hidden] get => GetProperty(name);
        [Hidden] set => SetProperty(name, value ?? undefined, true);
    }
    ...
    {
        [Hidden] get => (JSAttributes)((int)_attributes & publicAttributesMask);
    }
...
#pragma warning restore CA1707 // Идентификаторы не должны содержать символы подчеркивания
    ...
    public bool IsNull
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        get { return _valueType >= JSValueType.Object && _oValue == null; }
    }
    ...
    public bool IsNumber
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        get { return _valueType == JSValueType.Integer || _valueType == JSValueType.Double; }
    }
    ...
    internal bool NeedClone
    {
        ...
        get
        {
            return (_attributes & (JSValueAttributesInternal.ReadOnly | JSValueAttributesInternal.SystemObject)) ==
                   JSValueAttributesInternal.SystemObject;
        }
    }
    ...
    internal bool IsBox
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        get { return _valueType >= JSValueType.Object && _oValue != null && _oValue != this; }
    }
    ...
    protected internal virtual JSValue GetProperty(JSValue key, bool forWrite, PropertyScope propertyScope)
    {
        ...
        ExceptionHelper.Throw(
            new InvalidOperationException("Method GetProperty(...) of custom types must be overridden"));
        return null;
    }
    ...
    protected internal virtual void SetProperty(JSValue name, JSValue value, PropertyScope propertyScope,
        bool throwOnError)
    {
        JSValue field;
        if (_valueType >= JSValueType.Object)
        {
            ...
            if (field != null) field.SetProperty(name, value, propertyScope, throwOnError);
        }
    ...
    public override bool Equals(object obj)
    {
        ...
        if (ReferenceEquals(obj, this))
            return true;
        return StrictEqual.Check(this, obj as JSValue);
    }
    ...
    {
        return Context.CurrentGlobalContext.ProxyValue(action);
    }
    ...
    protected internal virtual IEnumerator<KeyValuePair<string, JSValue>> GetEnumerator(bool hideNonEnum,
    ...
    public virtual JSValue toString(Arguments args)
    {
        ...
        switch (self._valueType)
        {
            ...
            case JSValueType.Object:
            {
                ...
                if (tag.Defined) return $"[object {Tools.GetPropertyOrValue(tag, self)}]";

                if (self._oValue is Proxy)
                {
                    var hostedType = (self._oValue as Proxy)._hostedType;

                    if (hostedType == typeof(JSObject)) return "[object Object]";

                    return $"[object {hostedType.Name}]";
                }

                if (self.Value.GetType() == typeof(JSObject)) return "[object Object]";
    ...
    public virtual JSValue valueOf()
    {
        ...
        return _valueType < JSValueType.Object
            ? new JSObject { _valueType = JSValueType.Object, _oValue = this }
            : this;
    }
    ...
    protected sealed class ProtoConverterAttribute : ConvertValueAttribute
    {
        ...
        {
            if (source.ValueType < JSValueType.Object) return new JSObject { _valueType = JSValueType.Undefined };
