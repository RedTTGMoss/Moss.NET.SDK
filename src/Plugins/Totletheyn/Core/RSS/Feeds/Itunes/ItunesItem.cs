...
public class ItunesItem
{
    ...
    public ItunesItem(XElement itemElement)
    {
        ...
        if (imageElement != null) Image = new ItunesImage(imageElement);
        ...
        if (int.TryParse(itemElement.GetValue(ItunesChannel.NAMESPACEPREFIX, "order"), out var order)) Order = order;
